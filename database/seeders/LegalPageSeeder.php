...
<p>Master Skripsi menggunakan teknologi kecerdasan buatan (AI) dari penyedia pihak ketiga (Google Gemini API) untuk memproses permintaan Anda. Perlu Anda ketahui:</p>
<ul>
...
<ul>
    ...
    <li><strong>Penyedia Layanan AI:</strong> Google (Gemini API), untuk memproses permintaan pembuatan konten.</li>
...
<ul>
    <li><strong>Email:</strong> support@masterskripsi.my.id</li>
